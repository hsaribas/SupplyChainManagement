package com.scm.exception.message;
...
public class ErrorMessage {
    ...
    public final static String PRODUCT_NOT_FOUND_MESSAGE = "Product with name %s not found";
    public final static String PRODUCT_ALREADY_EXIST_MESSAGE = "Product: %s already exist";
